...
public class redRegionalsAutoClose extends NextFTCOpMode {
    ...
    Pose pickupRow2 = new Pose(12, 52, Math.toRadians(180)).mirror();
    Pose pickupClassifier = new Pose(11, 63, Math.toRadians(155)).mirror();
    Pose pickupRow1 = new Pose(18, 79, Math.toRadians(180)).mirror();
    Pose pickupRow3 = new Pose(12, 29, Math.toRadians(180)).mirror();
