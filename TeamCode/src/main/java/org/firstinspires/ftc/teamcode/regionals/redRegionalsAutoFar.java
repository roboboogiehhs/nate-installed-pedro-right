...
@Configurable
@Autonomous(name = "RED FAR autonomous", preselectTeleOp = "RED teleop")
public class redRegionalsAutoFar extends NextFTCOpMode {
    public redRegionalsAutoFar() {
        addComponents(
    ...
    Pose startPose = new Pose(50, 8, Math.toRadians(90)).mirror();
    Pose offLinePose = new Pose(20, 15, Math.toRadians(180)).mirror();
